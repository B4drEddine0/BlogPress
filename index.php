        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="px-8 py-10 mx-auto lg:max-w-screen-xl sm:max-w-xl md:max-w-full sm:px-12 md:px-16 lg:py-20 sm:py-16">
                <div class="grid gap-x-8 gap-y-12 sm:gap-y-16 md:grid-cols-2 lg:grid-cols-3">
                    <?php 
                    $query = "SELECT a.id_art, a.create_dat, a.title, a.content, a.Author_id, au.name_author 
                                FROM article a 
                    ...
                    <?php while($article = mysqli_fetch_assoc($result)) { ?>
                        <div class="relative">
                            <a href="details.php?id=<?php echo $article['id_art']; ?>" class="block overflow-hidden group rounded-xl shadow-lg">
                            ...
                            <div class="relative mt-5">
                                ...
                                <a href="details.php?id=<?php echo $article['id_art']; ?>" class="font-medium underline text-purple-600 dark:text-purple-400">Read More</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
